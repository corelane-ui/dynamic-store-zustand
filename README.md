# @corelane/dynamic-store-zustand
...
[![npm version](https://img.shields.io/npm/v/@corelane/dynamic-store-zustand.svg)](https://www.npmjs.com/package/@corelane/dynamic-store-zustand)
[![license](https://img.shields.io/npm/l/@corelane/dynamic-store-zustand.svg)](./LICENSE)
...
```bash
npm install @corelane/dynamic-store-zustand zustand
# or
yarn add @corelane/dynamic-store-zustand zustand
# or
pnpm add @corelane/dynamic-store-zustand zustand
```
...
```tsx
import { createDynamicStore } from "@corelane/dynamic-store-zustand";
...
} from "@corelane/dynamic-store-zustand";
...
```tsx
import { useDynamicStore } from "@corelane/dynamic-store-zustand";
...
```tsx
import { useDynamicStoreWithCleanup } from "@corelane/dynamic-store-zustand";
